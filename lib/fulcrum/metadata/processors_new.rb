module UMPTG::Fulcrum::Metadata
  require_relative File.join('processors', 'entryprocessor_new')
  require_relative File.join('processors', 'figureprocessor_new')
  ...
  def self.vendor_processor(vendor)
    ...
    when :default
      ...
      return {
                ...
                element: Processors::FigureProcessor.new,
