  ...
  <xsl:template name="citation-tag-ends">
    ...
    <xsl:template match="media">
        ...
        <xsl:choose>
            ...
            <!-- Handle Fulcrum Ableplayer media type 1 -->
            <xsl:when test="./*[local-name()='attrib' and @specific-use='umptg_fulcrum_ableplayer_embed_one']">
                <xsl:variable name="fulcrum_elem" select="./*[local-name()='attrib' and @specific-use='umptg_fulcrum_ableplayer_embed_one']"/>
                <xsl:variable name="identifier" select="$fulcrum_elem/*[local-name()='alternatives']/*[@specific-use='umptg_fulcrum_resource_identifier']"/>
                <xsl:variable name="title" select="$fulcrum_elem/*[local-name()='alternatives']/*[@specific-use='umptg_fulcrum_resource_title']"/>
                ...
                <xsl:element name="div">
                    <xsl:attribute name="class">
                        <xsl:value-of select="'ableplayer-embed-one-wrapper'"/>
                    </xsl:attribute>
                    <xsl:if test="$data-doi != ''">
                        <xsl:attribute name="data-doi">
                            <xsl:value-of select="$data-doi"/>
            ...
            <!-- Handle Fulcrum Ableplayer media type 2 -->
            <xsl:when test="./*[local-name()='attrib' and @specific-use='umptg_fulcrum_ableplayer_embed_two']">
            ...
            <!-- Handle Fulcrum Ableplayer media type 3 -->
            <xsl:when test="./*[local-name()='attrib' and @specific-use='umptg_fulcrum_ableplayer_embed_three']">
