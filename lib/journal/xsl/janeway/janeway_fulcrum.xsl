<xsl:stylesheet version="1.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    ...
    <xsl:template match="*[local-name()='media' and ./*[local-name()='attrib' and @specific-use='umptg_fulcrum_ableplayer']]">
        ...
        <xsl:variable name="resource_type_sign_link">
            <xsl:choose>
                <xsl:when test="$fulcrum_elem/ext-link[@specific-use='umptg_fulcrum_ableplayer_type_sign_link']/@xlink:href">
                    <xsl:value-of select="$fulcrum_elem/ext-link[@specific-use='umptg_fulcrum_ableplayer_type_sign_link']/@xlink:href"/>
                </xsl:when>
                <xsl:when test="$fulcrum_elem/alternatives/preformat[@specific-use='umptg_fulcrum_ableplayer_sign_identifier']">
                    <xsl:value-of select="concat('https://fulcrum.org/downloads/',$fulcrum_elem/alternatives/preformat[@specific-use='umptg_fulcrum_ableplayer_sign_identifier'],'?file=',$fulcrum_elem/alternatives/preformat[@specific-use='umptg_fulcrum_ableplayer_sign_identifier']/@preformat-type,'&amp;locale=en')"/>
                </xsl:when>
                <xsl:otherwise>
                    <xsl:value-of select="''"/>
                </xsl:otherwise>
        ...
        <xsl:variable name="resource_present_link">
            <xsl:choose>
                <xsl:when test="$fulcrum_elem/ext-link[@specific-use='umptg_fulcrum_ableplayer_present_link']/@xlink:href">
                    <xsl:value-of select="$fulcrum_elem/ext-link[@specific-use='umptg_fulcrum_ableplayer_present_link']/@xlink:href"/>
                </xsl:when>
                <xsl:when test="$fulcrum_elem/alternatives/preformat[@specific-use='umptg_fulcrum_ableplayer_present_identifier']">
                    <xsl:value-of select="concat('https://fulcrum.org/downloads/',$fulcrum_elem/alternatives/preformat[@specific-use='umptg_fulcrum_ableplayer_present_identifier'],'?file=',$fulcrum_elem/alternatives/preformat[@specific-use='umptg_fulcrum_ableplayer_present_identifier']/@preformat-type,'&amp;locale=en')"/>
                </xsl:when>
                <xsl:otherwise>
                    <xsl:value-of select="''"/>
                </xsl:otherwise>
        ...
        <xsl:variable name="resource_present_sign_link">
            <xsl:choose>
                <xsl:when test="$fulcrum_elem/ext-link[@specific-use='umptg_fulcrum_ableplayer_present_sign_link']/@xlink:href">
                    <xsl:value-of select="$fulcrum_elem/ext-link[@specific-use='umptg_fulcrum_ableplayer_present_sign_link']/@xlink:href"/>
                </xsl:when>
                <xsl:when test="$fulcrum_elem/alternatives/preformat[@specific-use='umptg_fulcrum_ableplayer_present_sign_identifier']">
                    <xsl:value-of select="concat('https://fulcrum.org/downloads/',$fulcrum_elem/alternatives/preformat[@specific-use='umptg_fulcrum_ableplayer_present_sign_identifier'],'?file=',$fulcrum_elem/alternatives/preformat[@specific-use='umptg_fulcrum_ableplayer_present_sign_identifier']/@preformat-type,'&amp;locale=en')"/>
                </xsl:when>
                <xsl:otherwise>
                    <xsl:value-of select="''"/>
                </xsl:otherwise>
        ...
        <xsl:element name="div">
            ...
            <xsl:element name="div">
                <xsl:attribute name="id">
                    <xsl:value-of select="concat('fulcrum-ableplayer-outer-',$identifier)"/>
                </xsl:attribute>
                <xsl:element name="div">
                    <xsl:attribute name="id">
                    ...
                    <xsl:element name="video">
                        ...
                        <xsl:element name="source">
                            <xsl:attribute name="type">
                                <xsl:value-of select="'video/webm'"/>
                            </xsl:attribute>
                            <xsl:attribute name="src">
