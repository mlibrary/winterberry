...
METADATA_FIELDS ||=
  [
    ...
    { object: :file_set, field_name: 'Resource Type', metadata_name: 'resource_type', required: true, multivalued: :yes, acceptable_values: [ '3D model', 'audio', 'chart', 'dataset', 'image', 'interactive map', 'map', 'musical example', 'text', 'video'], description: I18n.t('csv.descriptions.resource_type') },
    ...
    # TWB { object: :file_set, field_name: 'Allow Fullscreen Display?', metadata_name: 'allow_hi_res', required: true, multivalued: :no, acceptable_values: ['yes', 'no', 'not hosted on the platform'], description: I18n.t('csv.descriptions.allow_hi_res') },
    ...
    # TWB { object: :universal, field_name: 'CC License', metadata_name: 'license', required: false, multivalued: :yes, acceptable_values: Hyrax::LicenseService.new.select_all_options.map { |a| a[1] }, description: I18n.t('csv.descriptions.license') },
    { object: :universal, field_name: 'CC License', metadata_name: 'license', required: false, multivalued: :yes, acceptable_values: ['lic1', 'lic2'], description: I18n.t('csv.descriptions.license') },
...
ALL_KINDS = KINDS + ['cover']
# Any fields related to "representative" relationships between FileSets and their parent Monograph
FILE_SET_FLAG_FIELDS ||=
  [
    # TWB { object: :file_set, field_name: 'Representative Kind', metadata_name: 'representative_kind', required: false, multivalued: :no, acceptable_values: FeaturedRepresentative::KINDS + ['cover'], description: I18n.t('csv.descriptions.representative_kind') }
    { object: :file_set, field_name: 'Representative Kind', metadata_name: 'representative_kind', required: false, multivalued: :no, acceptable_values: ALL_KINDS, description: I18n.t('csv.descriptions.representative_kind') }
  ].freeze
